...
Version: 2.13.1-0ubuntu1
Binary: gnome-terminal, gnome-terminal-data
Maintainer: Arnaud Patard <arnaud.patard@rtp-net.org>
Architecture: any
Standards-Version: 3.6.2
Build-Depends: cdbs, debhelper (>= 4.1.0), liborbit2-dev (>= 1:2.10.2-1.1), intltool, libgnomeui-dev (>= 2.10.0), libvte-dev (>= 1:0.11.13), libglade2-dev (>= 2.5.1), scrollkeeper, libstartup-notification0-dev, libgnomevfs2-dev (>= 2.10.0), liblaunchpad-integration-dev, gnome-pkg-tools, docbook-to-man
...
Files: 
 4f8f4e2bd91e612088c957933f67b368 2514536 gnome-terminal_2.13.1.orig.tar.gz
 1a502731a3ec9eb91364fbcadc1cf2a5 22902 gnome-terminal_2.13.1-0ubuntu1.diff.gz

-----BEGIN PGP SIGNATURE-----
Version: GnuPG v1.4.2 (GNU/Linux)

iD8DBQFDvr7pr3O2CKlAUK8RAmmJAJ9tiRuJl4V6IX7jUY1cUdA8sZOfdgCfZtsw
GJ88MEPYxLbKlV5ii15IoB0=
=YZtc
-----END PGP SIGNATURE-----
