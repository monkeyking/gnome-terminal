...
Build-Depends: cdbs, debhelper (>= 4.1.0), liborbit2-dev (>= 1:2.10.2-1.1), intltool (>= 0.35), libgnomeui-dev (>= 2.10.0), libvte-dev (>= 1:0.15.3), libglade2-dev (>= 2.5.1), scrollkeeper, libstartup-notification0-dev, libgnomevfs2-dev (>= 2.10.0), gnome-pkg-tools, dpkg-dev (>= 1.13.19), docbook-to-man, liblaunchpad-integration-dev, gnome-doc-utils (>= 0.3.2), libgtk2.0-dev (>= 2.10), libgconf2-dev (>= 2.14.0)
...
Files: 
 adcbc455c47ee1776222448ef51dcf25 2956590 gnome-terminal_2.18.0.orig.tar.gz
 49394b5fb85d3b877b7f22cce703e223 34383 gnome-terminal_2.18.0-0ubuntu1.diff.gz

-----BEGIN PGP SIGNATURE-----
Version: GnuPG v1.4.6 (GNU/Linux)

iD8DBQFF9onfr3O2CKlAUK8RAjTmAJ9lDHEMfJTjz3s2of//3JxBQVZBvQCffC13
bf4mYgU7dp0pe+qeM+wHwkU=
=q4JC
-----END PGP SIGNATURE-----
