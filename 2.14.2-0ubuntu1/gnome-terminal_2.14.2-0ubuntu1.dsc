...
Build-Depends: cdbs, debhelper (>= 4.1.0), liborbit2-dev (>= 1:2.10.2-1.1), intltool, libgnomeui-dev (>= 2.10.0), libvte-dev (>= 1:0.11.13), libglade2-dev (>= 2.5.1), scrollkeeper, libstartup-notification0-dev, libgnomevfs2-dev (>= 2.10.0), gnome-pkg-tools, docbook-to-man, liblaunchpad-integration-dev
...
Files: 
 fe67648c5ae310c8aae8aa5a65ace21e 2673951 gnome-terminal_2.14.2.orig.tar.gz
 bff9047322e0f27938b4721879689423 21662 gnome-terminal_2.14.2-0ubuntu1.diff.gz

-----BEGIN PGP SIGNATURE-----
Version: GnuPG v1.4.2.2 (GNU/Linux)

iD8DBQFEhU+Lr3O2CKlAUK8RAqrhAJ9yNSmwcaBbmo8bbEr+jt7mUDmUAgCeOLbT
IPqSusrn9fRB0NWKMdbvhug=
=cgaE
-----END PGP SIGNATURE-----
